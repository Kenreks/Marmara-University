...
WHERE p.PlayerID=pt.PlayerID and pt.TeamID=t.TeamID and t.Name = 'Beþiktaþ' and p.age < (SELECT avg(p.age) FROM Player p) and p.FirstName not like '%nec%'
...
FROM
	...
	(SELECT t.TeamID, t.City FROM TEAM t) as teamCity,
